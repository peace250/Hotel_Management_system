...
<body>
  <nav class="d-flex flex-column align-items-center  justify-content-between w-100  nav-light" style=" height:100vh;  box-shadow: 4px 4px 10px rgba(0, 0, 0, 0.2);">
    <a href="" class="navbar-brand text-decoration-none fw-bold  p-3 text-primary text-center" style="font-size: 20px;">ITUZE</a>
<div class="list">
...
<div class="p-3">
  <a href="./logout.php" class="text-decoration-none fw-200 " style="color:rgb(13, 13, 14);">   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="30" height="30" fill="#000">
