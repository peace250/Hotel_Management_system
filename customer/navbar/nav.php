...
<body>
<nav class="navbar navbar-expand-sm d-flex flex-column border border-dark p-5 h-100 justify-content-between w-100" style="background-color: #fff;">
    <div class="div"><a href="#" class="navbar-brand fw-bold text-uppercase">ituze</a></div>
<ul class="nav  d-flex flex-column me-auto gap-3 ">
  <li class="nav-item">
    <a class="nav-link active" aria-current="page" href="nav.php">Home</a>
  </li>
  <li class="nav-item">
    <a class="nav-link text-dark text-capitalize" href="#">properties</a>
  </li>
  <li class="nav-item">
    <a class="nav-link text-dark text-capitalize" href="#">reviews</a>
  </li>
  <li class="nav-item">
    <a class="nav-link text-dark text-capitalize" href="#">Bookings</a>
  </li>
  <li class="nav-item">
    <a class="nav-link text-dark text-capitalize" href="#">payments</a>
  </li>
