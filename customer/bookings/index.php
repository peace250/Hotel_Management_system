...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])) {
    // id	user_id	property_id	check_in	check_out	status	total_price	created_at	image

    $id = intval($_POST['']);
    $propert_id = intval($_POST['propert_id']);
    $checkin = htmlspecialchars($_POST['checkin']);
    $checkout = htmlspecialchars($_POST['checkout']);
    $user_id = intval($_POST['user_id']); // Assuming you have a user ID
...
<body>
    ...
    <div class="container-fluid mt-5 p-4">
        <div class="row">
            ...
            <div class="col-md-3 mt-5">
                <h3 style="color:#031c3f">Hello $user</h3>
            </div>
        </div>
        <!-- Top row part end-->
        ...
        <!-- second main_row Area (start)-->
        <div class="row">
            <!-- Php codes area(displaying the card from the selected id)-->
            <div class="col-md-5 me-auto mt-5 ">
            <?php
                if (isset($_GET['id'])) {
                    $id = $_GET['id'];
                    // Query to fetch  the selected id of the hotel_room table.
                    ...
                    if (mysqli_num_rows($select_query) > 0) {
                        ...
                        <form action="#" method="POST">
                            ...
                            <!-- selected modal's booking -->
                            <div class="card mt-5" id="hotelroomModal">
                                <img src="../<?php echo $fetch['image'] ?>" class="card-img-top" alt="Hotel Image" id="modalImage">
                                <div class="card-body">
                                    <h5 class="card-title" id="modalTitle"><?php echo $fetch['name'] ?></h5>
                                    <div>
                                        <p class="card-text"><span class="fw-bold" id="modalPrice">Price: </span>$<?php echo $fetch['price'] ?> per night</p>
                                    </div>
                                    <div class="" id="modalDescription">
    ...
    <footer>
        ...
        <h5 class="text-center p-2">Peace_Muhayimana_All rights reserved&copy; 2025</h5>
    </footer>
