...
<body>
  <nav class="d-flex flex-column justify-content-between w-100 bg-light" style=" height:100vh;  box-shadow: 4px 4px 10px rgba(0, 0, 0, 0.2);">
    <div class="logo"><a href="" class="navbar-brand text-decoration-none fw-bold fixed-top p-3 " style="font-size: 20px; color:#1d3b52;">HAM_system</a></div>
...
<div class="p-3">
  <a href="./logout.php" class="text-decoration-none fw-200 " style="color:rgb(13, 13, 14);">   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="40" height="40" fill="#337bb2">
