...
if ($_SERVER['REQUEST_METHOD'] === "POST") {
    ...
    $sql_select = "SELECT * FROM customers WHERE `name` = ?";
 ...
 <body class="d-flex justify-content-center">
     ...
     <form action="" method="POST" class="col-sm-4 p-5 d-flex flex-column" style="height: fit-content;">
        ...
        <div class="register d-flex flex-column gap-3">
            ...
            <button class="btn border border-primary " style="border-radius: 8px;"> <a href="./register.php" class="text-decoration-none text-dark fw-bold">Sign_up_Here</a></button>
